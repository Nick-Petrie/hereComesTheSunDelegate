...
namespace assignment8ex1
{
    class Program
    {
        ...
        {
            SongDelegate songSequence = new SongDelegate(HereComesTheSun.chorus);
            songSequence += HereComesTheSun.verse1;
            songSequence += HereComesTheSun.chorus;
            songSequence += HereComesTheSun.verse2;
            songSequence += HereComesTheSun.chorus2;
            songSequence += HereComesTheSun.verse3;
            songSequence += HereComesTheSun.chorus;
            songSequence += HereComesTheSun.chorus;
            songSequence += HereComesTheSun.end;
